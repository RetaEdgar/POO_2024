...
from tkinter import messagebox, simpledialog, StringVar, IntVar, Entry, Button, Label, Frame
import getpass
...
class App:
    ...
    def main_menu(self):
        ...
        tk.Label(self.root, text="..:: Inicio de sesión ::..").pack(pady=10)
    ...
    def registro(self):
        ...
        tk.Label(self.root, text="..:: Registro en el Sistema ::..").pack(pady=10)
    ...
    def menu_inicial(self):
        ...
        tk.Label(self.root, text="..:: Menú Principal ::..").pack(pady=10)
        tk.Button(self.root, text="Clientes", command=self.menu_clientes).pack(pady=10)
    ...
    def menu_clientes(self):
        ...
        tk.Label(self.root, text="..:: Menú de Clientes ::..").pack(pady=10)
    ...
    def mostrar_datos_cliente(self):
        ...
        if id_cliente:
            ...
            if registros:
                info = "\n".join(f"Id: {fila[0]} - Nombre: {fila[1]} - Apellidos: {fila[2]} - Número de plan: {fila[3]}" for fila in registros)
                messagebox.showinfo("Datos del Cliente", info)
            else:
                messagebox.showwarning("No Encontrado", "No existen clientes con ese ID.")
        else:
            messagebox.showwarning("Campo vacío", "Por favor, proporciona un ID válido.")
    ...
    def actualizar_datos_cliente(self):
        ...
        if id_cliente and nombre and apellidos and plan:
    ...
    def menu_empleado(self):
        ...
        tk.Label(self.root, text="..:: Menú Empleados ::..").pack(pady=10)
    ...
    def modificar_planes(self):
        ...
        tk.Label(self.root, text="..:: Menú de Planes ::..").pack(pady=10)
    ...
    def añadir_plan(self):
        ...
        if nombre_plan and precio_plan:
    ...
    def modificar_clientes(self):
        ...
        tk.Label(self.root, text="..:: Modificar Clientes ::..").pack(pady=10)
    ...
    def agregar_cliente(self):
        ...
        if nombre and apellidos and plan:
            # Agregar lógica para agregar un nuevo cliente aquí
            resultado = cliente.Cliente.crear(nombre,apellidos,plan)
            if resultado:
    ...
    def acceder_servicios(self):
        ...
        tk.Label(self.root, text="..:: Acceder Servicios ::..").pack(pady=10)
    ...
    def agregar_servicio(self):
        ...
        if cliente_id and empleado_id and descripcion:
    ...
    def modificar_empleados(self):
        ...
        tk.Label(self.root, text="..:: Modificar Empleados ::..").pack(pady=10)
    ...
    def agregar_empleado(self):
        ...
        if nombre and apellidos and puesto and salario and horario:
